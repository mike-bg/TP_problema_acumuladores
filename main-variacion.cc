...
int main(int argc, char** argv) {
	...
	AcumuladorVariacion<float> acc_float;
	acc_float.push(5.0f);	
	acc_float.push(-1.0f);	
	acc_float.push(2.0f);	
	acc_float.push(3.0f);	
	...
	AcumuladorVariacion<int> acc_int;
	acc_int.push(5);	
	acc_int.push(-1);	
	acc_int.push(2);	
	acc_int.push(3);	
	...
	AcumuladorVariacion<std::complex<float>> acc_complex;
	...
	AcumuladorVariacion<std::vector<float>> acc_vector;
